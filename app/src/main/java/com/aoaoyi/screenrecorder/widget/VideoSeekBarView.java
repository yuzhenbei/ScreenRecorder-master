...
public class VideoSeekBarView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(thumbWidth / 2, getMeasuredHeight() / 2 - DeviceWindowUtil.dp(getContext(), 1), getMeasuredWidth() - thumbWidth / 2, getMeasuredHeight() / 2 + DeviceWindowUtil.dp(getContext(), 1), innerPaint1);
